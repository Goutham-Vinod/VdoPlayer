...
class _SettingsState extends State<Settings> {
            ...
            ListTile(
              ...
              onTap: () {
                dialogBoxWidget(
                    context,
                    "Are you sure?",
                    "All the playlist will be deleted and the app will restart.",
                    "Reset", () {
                  clearPlaylistDb();
  ...
  Future showAboutUs(context) async {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text("About Us"),
          content: const Text(
              '''Vdo Player is a simple and user-friendly video player that has multiple functionalities
...
We try to improve our app day by day
  ...
  Future showPrivacyPolicy(context) async {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return SingleChildScrollView(
          child: AlertDialog(
            ...
            content: const Text(
                '''Goutham V built the Vdo Player app as a Free app. This SERVICE is provided by Goutham at no cost and is intended for use as is.
